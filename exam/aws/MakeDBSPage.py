...
def open_exam_cache(driver, pageno):
    ...
    if (len(div_questions) < QUESTIONS_PER_PAGE and pageno < PAGE_COUNTS):
        return open_exam_site(driver, pageno)

    return

def open_exam_site(driver, pageno):
    exam_url = 'https://www.examtopics.com/exams/amazon/aws-certified-database-specialty/view/' + str(pageno) + '/'
